...
US210 | Project details | high | As a Project Member, I want to see the project details of a project that I am currently working on |
US28 | View team members profiles | medium | As a Project Member, I want to see the user profiles of my team members |
US29 | Search task | medium | As a Project Member, I want to search for a specific task inside a project |
